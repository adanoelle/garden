...
# Regenerate app icons from source (assets/icon-source.png)
gen-icons:
    @echo "🎨 Generating icons from assets/icon-source.png..."
    cd apps/desktop && pnpm tauri icon ../../assets/icon-source.png
    cp apps/desktop/src-tauri/icons/32x32.png apps/web/public/favicon-32x32.png
    cp apps/desktop/src-tauri/icons/icon.ico apps/web/public/favicon.ico
    cp apps/desktop/src-tauri/icons/icon.png apps/web/public/apple-touch-icon.png
